...
- [Picovoice SDK for Arduino boards - French language](#picovoice-sdk-for-arduino-boards---french-language)
...
1. Compile and upload the `Picovoice_FR/GetUUID` sketch from the `File -> Examples` menu. Copy the UUID of the board printed at the beginning of the session to the serial monitor.
